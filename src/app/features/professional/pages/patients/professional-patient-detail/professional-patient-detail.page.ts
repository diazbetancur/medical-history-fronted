...
import { ProfessionalPatientAllergiesTabComponent } from '@patient/pages/allergies/professional-patient-allergies-tab/professional-patient-allergies-tab.component';
import { ProfessionalPatientBackgroundTabComponent } from '@patient/pages/background/professional-patient-background-tab/professional-patient-background-tab.component';
import { ProfessionalPatientExamsTabComponent } from '@patient/pages/exams/professional-patient-exams-tab/professional-patient-exams-tab.component';
import { ProfessionalPatientMedicationsTabComponent } from '@patient/pages/medications/professional-patient-medications-tab/professional-patient-medications-tab.component';
